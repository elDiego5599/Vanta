export function VantaLogo({ className = 'w-8 h-8' }) {
  return (
...
const IcoBase = ({ children, w = 24, h = 24, c = 'currentColor' }) => (
...
export const Ico = {
  shield: (c) => (
    <IcoBase c={c}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></IcoBase>
  ),
  brain: (c) => (
    <IcoBase c={c}>
