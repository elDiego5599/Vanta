          ...
          <PremiumEdgeWrapper rounded="rounded-[32px]">
            <div className="p-12 md:p-20 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 bg-[var(--card-bg)] rounded-[31px]">
              ...
              <div className="flex flex-col items-start lg:items-center gap-4 mt-6 lg:mt-0 shrink-0">
                <MagneticButton>
                  <button className="px-10 py-5 text-[13px] font-bold tracking-widest uppercase rounded-full bg-[var(--btn-bg)] text-[var(--btn-text)] transition-transform hover:scale-105 outline-none focus-visible:ring-4 focus-visible:ring-[var(--border-strong)]">
                    Descargar Vanta
                  </button>
                </MagneticButton>
